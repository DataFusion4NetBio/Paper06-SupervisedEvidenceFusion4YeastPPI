...
die "Usage: command yeast_pr_pair_file_name yeast_name_list gene_expression_file  percent_miss out_file_name\n" if scalar(@ARGV) < 5;

my ($pr_pair_file, $gene_list_file, $gene_expression_file,  $percent_miss, $out_file_name) = @ARGV;
